...
- Hardens service-card prose against late-loading theme rules, including
  `!important` background, pixel-font, alignment, and vertical-writing rules.
- Adds a deliberately hostile theme to the responsive fixture so browser QA
  verifies computed styles instead of only checking that selectors exist.
