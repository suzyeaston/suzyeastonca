...
$main_cards = array(
    ...
    array('label' => 'SIDE D', 'title' => 'Built from Vancouver', 'body' => 'A lot of my work starts with the city around me: transit, venues, small businesses, housing pressure, weird outages, civic data, rain, noise, and the feeling that useful tools should have personality. I\'m interested in technology that helps real people navigate messy systems, not just shinier dashboards for people who already have too many dashboards.'),
);
?>
    ...
    <section class="bio-page" aria-label="Bio page">
        <div class="bio-shell">
            <header class="bio-hero">
                <p class="bio-kicker"><?php echo esc_html( 'VANCOUVER TRANSMISSION // MUSIC • SYSTEMS • AI' ); ?></p>
                <h1 class="bio-title"><?php echo esc_html( 'SUZY EASTON' ); ?></h1>
                <p class="bio-subtitle"><?php echo esc_html( 'Musician. Creative technologist. Senior technical generalist. Builder of useful weird systems.' ); ?></p>
                <p class="bio-intro"><?php echo esc_html( 'I’m a Vancouver-born musician and technical systems fixer. I came up through piano lessons, open mics, recording arts, touring vans, loud rooms, broken gear, and studio floors, which is a pretty good training program for chaos.' ); ?></p>
                <p class="bio-intro"><?php echo esc_html( 'That same instinct runs through my technical work now: QA automation, IT operations, cloud-connected systems, identity/security, SaaS troubleshooting, APIs, production debugging, and practical AI tools. The through-line is simple: turn chaos into working systems, ship the useful thing, and keep enough personality in it that people remember it exists.' ); ?></p>
                ...
                <div class="bio-terminal-strip" aria-label="Operator metadata">
                    ...
                    <span><?php echo esc_html( 'STATUS: ONLINE' ); ?></span>
                </div>
            ...
            <section class="bio-proof-panel" aria-labelledby="bio-proof-title">
                <div class="bio-proof-panel__header">
                    <h2 id="bio-proof-title"><?php echo esc_html( 'ARCHIVE RECEIPTS' ); ?></h2>
                ...
                <div class="bio-proof-panel__grid">
                    ...
                    <article class="bio-proof-card"><p class="bio-proof-card__label">LOCAL RADIO</p><h3 class="bio-proof-card__title">CiTR airplay</h3><p class="bio-proof-card__body">“A Little Louder” received airplay on UBC’s CiTR, a local radio nod from the campus and community radio world that helped shape so much Vancouver music culture.</p></article>
                    <article class="bio-proof-card"><p class="bio-proof-card__label">FEATURED TRACK</p><h3 class="bio-proof-card__title">A Little Louder</h3><p class="bio-proof-card__body">A short, loud rock dispatch from the music side of the operation. Part confidence anthem, part reminder to take up space.</p><div class="bio-bandcamp-embed"><iframe style="border: 0; width: 350px; height: 470px;" src="https://bandcamp.com/EmbeddedPlayer/album=901825062/size=large/bgcol=ffffff/linkcol=0687f5/tracklist=false/transparent=true/" seamless title="A Little Louder by Suzy Easton on Bandcamp"><a href="https://suzyeaston.bandcamp.com/album/a-little-louder">A Little Louder by Suzy Easton</a></iframe></div></article>
                </div>
            </section>

            <section class="bio-builds" aria-labelledby="bio-builds-title"><div class="bio-builds__header"><h2 id="bio-builds-title">CURRENT ROTATION</h2><p>A few active projects from the lab: music, code, prototypes, and civic-tech weirdness all feeding the same machine.</p></div><div class="bio-builds__grid">
                <article class="bio-build"><h3 class="bio-build__title">A Little Louder</h3><p class="bio-build__meta">self-released rock single</p><p class="bio-build__body">A short, loud rock dispatch from the music side of the operation, built around confidence, volume, and taking up space.</p><a class="bio-build__link" href="<?php echo esc_url( 'https://suzyeaston.bandcamp.com/album/a-little-louder' ); ?>" target="_blank" rel="noopener">Listen on Bandcamp</a></article>
                <article class="bio-build"><h3 class="bio-build__title">suzyeaston.ca</h3><p class="bio-build__meta">custom WordPress/PHP portfolio and creative-tech sandbox</p><p class="bio-build__body">Retro UI, REST/API workflows, custom templates, AI-assisted prototyping, audio experiments, and interactive web projects.</p><a class="bio-build__link" href="<?php echo esc_url( '/projects/' ); ?>">Open projects hub</a></article>
                <article class="bio-build"><h3 class="bio-build__title">Gastown Simulator</h3><p class="bio-build__meta">Vancouver browser-world prototype</p><p class="bio-build__body">A first-person Vancouver corridor experiment using civic/open-data flavour, route anchors, weather/time controls, and iterative product design.</p><a class="bio-build__link" href="<?php echo esc_url( home_url( '/gastown-sim/' ) ); ?>">Explore prototype</a></article>
                <article class="bio-build"><h3 class="bio-build__title">VanOps Radar / Lousy Outages</h3><p class="bio-build__meta">local ops and status monitoring concepts</p><p class="bio-build__body">Vancouver-first operational tools for outages, transit, roads, weather context, provider weirdness, and business continuity.</p><p><a class="bio-build__link" href="<?php echo esc_url( '/vanops-radar/' ); ?>">VanOps Radar</a> <a class="bio-build__link" href="<?php echo esc_url( '/lousy-outages/' ); ?>">Lousy Outages</a></p></article>
            ...
            <section class="bio-cta-panel" aria-labelledby="bio-cta-title"><h2 class="bio-cta-panel__title" id="bio-cta-title">WORK WITH SUZY</h2><p class="bio-cta-panel__body">If you need someone who can debug the weird issue, automate the boring thing, test the fragile workflow, clean up the dashboard, explain the system, or make the project feel less cursed, I’m probably your person.</p><div class="bio-cta-panel__actions"><a class="bio-button" href="<?php echo esc_url( 'mailto:suzyeaston@icloud.com?subject=Work%20With%20Suzy' ); ?>">Email Suzy</a><a class="bio-button" href="<?php echo esc_url( '/work-with-suzy/' ); ?>">Work With Suzy</a><a class="bio-button" href="<?php echo esc_url( '/projects/' ); ?>">Projects</a><a class="bio-button" href="<?php echo esc_url( 'https://github.com/suzyeaston' ); ?>" target="_blank" rel="noopener">GitHub</a></div></section>
        </div>
    </section>
</main>
