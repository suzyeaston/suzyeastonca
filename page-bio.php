...
$main_cards = array(
    ...
    array('label' => 'SIDE D', 'title' => 'Vancouver transmission', 'body' => 'A lot of my work starts with the city around me: transit, venues, small businesses, housing pressure, weird outages, civic data, rain, noise, and the feeling that useful tools should have personality. I\'m interested in technology that helps real people navigate messy systems, not just shinier dashboards for people who already have too many dashboards.'),
);
?>
    ...
    <section class="bio-page" aria-label="Bio page">
        <div class="bio-shell">
            <header class="bio-hero">
                ...
                <p class="bio-intro"><?php echo esc_html( 'That same instinct now runs through my technical work: QA automation, IT operations, cloud-connected systems, identity/security, SaaS troubleshooting, APIs, production debugging, and practical AI tools. The through-line is simple: turn chaos into working systems, make the useful thing ship, and get a little louder when the moment calls for it.' ); ?></p>
