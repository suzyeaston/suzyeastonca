...
function retro_game_music_theme_scripts() {
    ...
    wp_enqueue_script('piano-script', get_template_directory_uri() . '/js/piano-script.js', array(), '1.0.0', true);

    wp_enqueue_script('game-like-init', get_template_directory_uri() . '/js/game-like-init.js', array(), '1.0.0', true);
}
