...
test('attention badges and cards have intrinsic desktop and mobile bounds', () => {
  ...
  assert.match(css, /\.lousy-outages \.lo-service-card \.lo-service-card__diagnostic p,[^}]*\.lousy-outages \.lo-service-card \.lo-service-card__footer p\s*{[^}]*background: transparent !important[^}]*font-family: Inter[^}]*!important[^}]*writing-mode: horizontal-tb !important/s);
});
